...
% Initialize population 10 bits (0 for not selected, 1 for selected)
...
for generation = 1:maxGeneration
    ...
    eliteIndices = eliteIndices(1:eliteCount);
    eliteMembers = population(eliteIndices, :);
    ...
    % Replace the worst individuals with elite members
    mutatedOffspring(1:eliteCount,:) = eliteMembers;
